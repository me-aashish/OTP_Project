...
public class OtpService {
	...
	public OtpResponseDTO generateOtp(String authorizationHeader) throws MessagingException {
		...
		otpResponseDTO.setMessage("otp sent to registered email, use this request ID to validate otp");
	...
	public OtpResponseDTO validateOtpAndDownloadDocument(String authorizationHeader, OtpRequestDTO otpRequestDTO,
		...
		if (passwordEncoder.matches(otpString, mfaValidation.getOtp())) {
			...
			throw new InvalidOtpException("Wrong OTP or OTP expired, please generate a new one");
		}

	}

	public OtpResponseDTO validateOtp(String authorizationHeader, OtpRequestDTO otpRequestDTO)
